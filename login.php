...
<head>
    ...
    <title> Login SIAS KPU KAB. BARITO UTARA | Sign in</title>
    <!-- Bootstrap -->
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
						...
						<div style="text-align: center;">
                                <img src="assets/img/kpu.png" alt="Logo" style="max-width: 120px; margin-bottom: 20px;">
                            </div>
                            <p style="text-align: center; font-size: 18px"><strong>SISTEM INFORMASI ARSIP SURAT<br>(SIAS)<br>KPU KABUPATEN BARITO UTARA</strong></p>
