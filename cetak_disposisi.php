...
?>
	...
	<div class="row" align="center">
		<div class="header">
			<img src="assets/img/kpu.png" class="logo1">
			<img src="assets/img/kabbarut.png" class="logo2">
			<h6 class="text">KOMISI PEMILIHAN UMUM<br> KABUPATEN BARITO UTARA <br> PROVINSI KALIMANTAN TENGAH</h6>
			<h4>Jl. Ahmad Yani No.26 Muara Teweh Kode Pos 73811</h4>
			<td colspan="3" bordered="#000000">
				<div align="center" style="border: solid; font-size: 10px;">
					Email: kab_baritoutara@kpu.go.id | Web: kab-baritoutara.go.id
				</div>
			</td>
		</div>
		<br>
		...
		<div id="lead">
			<p>Mengetahui,<br>
			Sekretaris KPU Kabupaten Barito Utara</p>
			<div style="height: 50px"></div>
			<p class="lead">Agodiansyah, S.H.</p>
			<p>NIP. 19660506 199303 1 011</p>
		</div>
	</div>	
